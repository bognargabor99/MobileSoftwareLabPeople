            ...
            Box(
                ...
                Column(modifier = Modifier.padding(20.dp)) {
                        ...
                        item {
                            Text(
                                modifier = Modifier
                                    ...
                                    .padding(6.dp)
                                    .border(
                                        width = if (chosenCategory == "") 1.dp else 0.dp,
                                        color = MaterialTheme.colorScheme.run {if ("" == chosenCategory) primary else background },
                                        shape = RoundedCornerShape(3.dp)
                                    )
                                    .clickable { chosenCategory = "" },
                    ...
                    Box(modifier = Modifier.padding(40.dp, 0.dp, 40.dp, 0.dp)) {
                        Button(
                            onClick = { onChoose(chosenCategory) },
...
@Preview
@Composable
fun CategoryChooserDialogPreview() {
    CategoryChooserDialog(
        subtitle = stringResource(R.string.choose_category_view_detailed),
